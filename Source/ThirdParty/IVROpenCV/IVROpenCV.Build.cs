...
public class IVROpenCV : ModuleRules
{
	public IVROpenCV(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
            ...
            string BinaryPath = Path.GetFullPath(Path.Combine(ModuleDirectory, "../../../Binaries/ThirdParty/IVROpenCV", PlatformDir));
			...
			PublicDefinitions.Add("OPENCV_PLATFORM_PATH=Binaries/ThirdParty/IVROpenCV/" + PlatformDir);
